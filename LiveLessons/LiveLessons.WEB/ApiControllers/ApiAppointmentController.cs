...
namespace LiveLessons.WEB.ApiControllers
{
    ...
    public class ApiAppointmentController : ApiController
    {
        ...
        public ApiAppointmentController(IAppointmentService appointmentService)
        {
        ...
        [HttpPost, Route("")]
        public IHttpActionResult Create(AppointmentViewModel appointmentViewModel)
        {
        ...
        [HttpPut, Route("")]
        public IHttpActionResult Edit(AppointmentViewModel appointmentViewModel)
        {
            if (ModelState.IsValid)
            {
                var appointmentDto = Mapper.Map<AppointmentDto>(appointmentViewModel);
